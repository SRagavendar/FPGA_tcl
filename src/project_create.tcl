...
# -- Description :
# --
# -- 1. Used to create projects using a script
# -- 2. The location of the script in the project is ./src/tcl/
# -- 3. To create a project, you need to set only three variables
# - 		PartDev - FPGA chip type
# - 		PrjDir - project working directory (WITHOUT PROJECT NAME)
# - 		TopName - name of the project name and top-level file
# -- 4. You can extend the use of the script to the Synthesis and Implement stages.
# --
# ----------------------------------------------------------------------------
...
proc findFiles { basedir pattern } {
	...
	# Ensures the directory name is in the native format for the platform and contains a final directory seperator
	...
	# Looking for any sub directories in the current directory
	foreach dirName [glob -nocomplain -type {d r} -path $basedir *] {
		# Recursively call the routine on the sub directory and append any new files to the results
...
# ----- Stage 0: Project Name and directory path ----- #
...
set PartDev "xc7e327tffg990-4"
set PrfDir [string range $TclPath 0 [string last / $NewLoc]]
set TopName [string range $NewLoc [string last / $NewLoc]+1 end]

# ----- Stage 2: Auto-complete path ----- #
set PrjName $TopName.xpr
set SrcDir $PrfDir/$TopName/src
set VivNm "vivado"
...
# ----- Stage 5: Find PCI-E Module and sub-dirs for simulation sources ----- #
